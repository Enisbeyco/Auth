        ...
        <div class="row">
            <div class="col-md-6">
                <div class="error-template">
                    <h1>:) Tüh!</h1>
                    <h2>Geçici olarak bakımdayız</h2>
                    <h1>Çok yakında geri döneceğiz!</h1>
                    <div>
                        <p>
                            Verdiğimiz rahatsızlıktan dolayı özür dileriz. Şu anda sistemlerimizde bakım çalışması gerçekleştiriyoruz.
                            Kısa süre içinde tekrar yayında olacağız!
                        </p>
                        <p>— EnisBey.Jr</p>
                    </div>
                    <div class="error-actions">
                        <a href="login.php" style="margin-top: 10px;" class="btn btn-info btn-lg">
                            <span class="glyphicon glyphicon-home"></span> Giriş Sayfasına Dönün
                        </a>
                    </div>
                </div>
            </div>
